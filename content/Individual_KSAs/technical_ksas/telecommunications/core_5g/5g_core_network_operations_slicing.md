...
source_frameworks:
  - "3GPP TS 28.541 — Management and orchestration: 5G Network Resource Model (3GPP standards body; publicly available)"
  - "3GPP TS 23.501 — System Architecture for the 5G System (3GPP standards body; publicly available)"
  - "TM Forum Open Digital Architecture (ODA) Open APIs (industry association — TeleManagement Forum; conceptual alignment only)"
  - "ETSI GR NFV-IFA 029 — Report on Network Function Virtualisation (ETSI; publicly available)"
  - "Linux Foundation Anuket Reference Model for cloud-native network functions (open-source foundation — Linux Foundation; publicly available)"
proficiency_levels:
  - level: Awareness
