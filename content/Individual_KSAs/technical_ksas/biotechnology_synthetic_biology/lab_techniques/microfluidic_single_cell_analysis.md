...
source_frameworks:
  - "Nature Reviews Methods Primers: Microfluidic Single-Cell Omics (2025) — academic journal; conceptual alignment only"
  - "ISO 20359-1:2023 Microfluidics — Measurement methods for flow properties of microfluidic devices — ISO proprietary standard; conceptual alignment only"
proficiency_levels:
  - level: Awareness
  ...
  - level: Intermediate
    indicator: Adjusts microfluidic platform settings (droplet size, flow rates) based on cell type requirements; interprets single-cell library quality metrics; applies standard data analysis pipelines (e.g., Seurat, Scanpy) to identify cell populations.
  - level: Advanced
