...
horizon: perennial
cluster_tags: ["Formalisation","Social Protection","Regulatory Compliance"]
...
source_frameworks: ["ILO Transition from the Informal to the Formal Economy Recommendation (No. 204)","World Bank Social Protection & Jobs Core Diagnostic"]
proficiency_levels:
  - level: Awareness
  ...
  - level: Advanced
    indicator: Designs community outreach on formalisation; negotiates group‑registration incentives; analyses programme uptake data.
  - level: Expert
