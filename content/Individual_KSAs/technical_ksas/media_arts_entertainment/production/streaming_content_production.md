...
source_frameworks:
  ...
  - "Netflix Production Media Management documentation — vendor documentation — Netflix; conceptual alignment only — equivalent OTT platform production standards may apply"
proficiency_levels:
  - level: Awareness
    indicator: Distinguishes live vs VOD streaming delivery models; identifies major streaming platform categories and their content formats; lists common codec and bitrate targets for standard-definition and HD delivery.
  - level: Basic
