...
source_frameworks:
  - "OpenZeppelin Smart Contract Security Audit methodology and documentation — commercial open-source security project — OpenZeppelin; conceptual alignment only"
  - "CertiK Smart Contract Assessment Criteria — commercial audit firm — CertiK; conceptual alignment only"
  - "Ethereum smart contract security best practices and SWC Registry — open-source foundation/community — Ethereum Foundation; publicly available"
proficiency_levels:
  - level: Awareness
