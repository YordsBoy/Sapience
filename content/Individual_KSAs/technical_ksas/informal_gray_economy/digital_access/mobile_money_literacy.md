...
source_frameworks:
  - "GSMA Digital Financial Literacy Toolkit — commercial industry association — GSMA; conceptual alignment only"
  - "GSMA Mobile Internet Skills Training Toolkit (MISTT) — commercial industry association — GSMA; conceptual alignment only"
  - "GSMA Mobile Money programme guidelines and operator documentation — commercial industry association — GSMA; conceptual alignment only"
proficiency_levels:
  - level: Awareness
  ...
  - level: Expert
    indicator: Educates community on digital-payment security and adoption; partners with agents; advocates consumer-protection policies.
---
